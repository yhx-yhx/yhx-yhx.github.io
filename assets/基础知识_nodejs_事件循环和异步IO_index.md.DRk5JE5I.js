import{ak as a,h as n,aE as i,f as l}from"./chunks/framework.DMTyxyBf.js";const c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"基础知识/nodejs/事件循环和异步IO/index.md","filePath":"基础知识/nodejs/事件循环和异步IO/index.md","lastUpdated":1713792803000}'),p={name:"基础知识/nodejs/事件循环和异步IO/index.md"};function e(h,s,t,k,D,A){return l(),n("div",null,s[0]||(s[0]=[i(`<h2 id="_01-事件循环和异步io" tabindex="-1">01 事件循环和异步IO <a class="header-anchor" href="#_01-事件循环和异步io" aria-label="Permalink to &quot;01 事件循环和异步IO&quot;">​</a></h2><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> * </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> */</span></span></code></pre></div>`,2)]))}const r=a(p,[["render",e]]);export{c as __pageData,r as default};
