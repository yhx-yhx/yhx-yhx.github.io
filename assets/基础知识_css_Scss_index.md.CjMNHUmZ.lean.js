import{ak as n,h as a,aE as p,f as e}from"./chunks/framework.DMTyxyBf.js";const u=JSON.parse('{"title":"scss","description":"","frontmatter":{},"headers":[],"relativePath":"基础知识/css/Scss/index.md","filePath":"基础知识/css/Scss/index.md","lastUpdated":1713792803000}'),l={name:"基础知识/css/Scss/index.md"};function i(r,s,c,b,t,d){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="scss" tabindex="-1">scss <a class="header-anchor" href="#scss" aria-label="Permalink to &quot;scss&quot;">​</a></h1><h2 id="变量" tabindex="-1">变量 <a class="header-anchor" href="#变量" aria-label="Permalink to &quot;变量&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$color:blue;</span></span>
...
<span class="line"><span>​\`\`\` --&gt;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div>`,21)]))}const m=n(l,[["render",i]]);export{u as __pageData,m as default};
