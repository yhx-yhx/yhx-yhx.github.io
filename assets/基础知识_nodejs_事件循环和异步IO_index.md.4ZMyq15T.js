import{ak as n,h as a,aE as i,f as l}from"./chunks/framework.Dig6RImq.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"基础知识/nodejs/事件循环和异步IO/index.md","filePath":"基础知识/nodejs/事件循环和异步IO/index.md","lastUpdated":1713792803000}'),p={name:"基础知识/nodejs/事件循环和异步IO/index.md"};function e(r,s,t,h,k,c){return l(),a("div",null,s[0]||(s[0]=[i(`<h2 id="_01-事件循环和异步io" tabindex="-1">01 事件循环和异步IO <a class="header-anchor" href="#_01-事件循环和异步io" aria-label="Permalink to &quot;01 事件循环和异步IO&quot;">​</a></h2><div class="vp-code-block-title"><div class="vp-code-block-title-bar"><span class="vp-code-block-title-text" data-title="index.js">index.js</span></div><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
